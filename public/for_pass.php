    ...
    <div class="auth-card">
        <div class="auth-form-container">
            ...
            <?php if ($feedback_message): ?>
                <div class="message <?php echo isset($is_error) ? 'error-message' : 'success-message'; ?>"><?php echo htmlspecialchars($feedback_message); ?></div>
            <?php endif; ?>
            <?php if (empty($feedback_message) || isset($is_error)): ?>
