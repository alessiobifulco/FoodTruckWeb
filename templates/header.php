...
// Questa logica serve per mostrare/nascondere le icone. La lascio perché è corretta.
    ...
    <header class="header-fixed-top">
        <nav class="header-nav">
            <div class="header-left">
                <a href="index.php" aria-label="Torna alla Home">
            ...
            <div class="header-right">
                <?php if ($is_logged_in): ?>
                    ...
                    <a href="carrello.php" aria-label="Carrello">
